...
/*   Updated: 2015/04/14 05:18:52 by mbougrin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			Bureaucrat::executeForm(Form const &rhs) const
{
	try {
		rhs.execute(*this);
		std::cout << this->_name << " executes " << rhs.getName() << std::endl;
	} catch (std::exception & e) {
		std::cout << this->_name << " cannot execute " << rhs.getName();
